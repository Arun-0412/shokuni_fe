...
export class SaloonService {
  ...
  getUserStripeDetails (barberId:number):Observable<any> {
    let url = 'https://api.shokuni.co.uk/v2/getstripeid/' + barberId;
    let headers = new HttpHeaders ({Authorization: this.vars.getAuthToken() });
  ...
  saveStripeAccount (values, barberId:number):Observable <any> {
    let url = 'https://api.shokuni.co.uk/v2/storeStripeKeys';
      let params: any = {
        "userid": barberId,
  ...
  getStripeURL (barberId:number):Observable <any> {
    let url = 'https://api.shokuni.co.uk/v2/createStripeAccount'
    let params: any = {
      "userid":barberId
  ...
  getStripeAccountDetails (stripeId:string):Observable <any> {
    let url = 'https://api.shokuni.co.uk/v2/getStripeAccount/'+ stripeId
    let headers = new HttpHeaders ({Authorization: this.vars.getAuthToken() });
  ...
  getStripeStatus (stripeId:string):Observable <any> {
    let url = 'https://api.shokuni.co.uk/v2/getStripeAccountLink/'+ stripeId
    let headers = new HttpHeaders ({Authorization: this.vars.getAuthToken() });
